...
nmap_leader('fs', pick_workspace_symbols_live, 'Symbols workspace')
...
-- s is for 'Session'
nmap_leader('sd', ':AutoSession deletePicker<CR>', 'Delete Picker')
nmap_leader('ss', ':AutoSession search<CR>', 'Search')
